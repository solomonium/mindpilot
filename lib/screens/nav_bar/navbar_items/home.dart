...
class _HomeScreenState extends State<HomeScreen> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      try {
        ...
        if (authStore.displayName != null &&
            authStore.displayName!.trim().isNotEmpty) {
  ...
  Future<void> _speakWelcome(String name) async {
    try {
      ...
      final welcomeBackText = R.S.welcomeBackSubtitle;

      await _welcomeTts.stop();
      await _welcomeTts.setLanguage("en-US");
      await _welcomeTts.setSpeechRate(0.5);
      await _welcomeTts.speak("$greeting, $firstName. $welcomeBackText");
    } catch (e) {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: theme.foundationColor.withOpacity(
                                      0.1,
                                    ),
                                    blurRadius: 4,
                                  ),
                  ...
                  Padding(
                    ...
                    child: Consumer<GroupQuizProvider>(
                      builder: (context, provider, _) {
                        if (provider.restoredGroupId == null)
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        final groupId =
                                            provider.restoredGroupId!;
                                        await provider.leaveRestoredGroup(
                                          groupId,
                                        );
                                      },
                                    ),
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Consumer<NotificationProvider>(
                                  builder: (context, notifStore, _) {
                                    if (notifStore.lastInsightDate == null)
                                      return const SizedBox();

                                    try {
                                      final date = DateTime.parse(
                                        notifStore.lastInsightDate!,
                                      );
                                    ...
                                    Text.rich(
                                      TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text:
                                                "- ${notifStore.dailyInsightAuthor ?? "Unknown"}",
                                            style: GoogleFonts.inter(
                                ...
                                child: Consumer2<NotificationProvider, AppAuthProvider>(
                                  builder: (context, notifStore, authStore, _) {
                                    ...
                                    return Container(
                                      ...
                                      if (!isPro &&
                                          authStore.explanationCount >= 3) {
                                        AppHelper.watchAdForAction(
                                          context,
                                          promptText:
                                              'You have used your 3 free explanations for today. Watch a video ad to get 1 more explanation credit!',
                                          onReward: () async {
                                            await authStore
                                                .rewardExplanationCount();
                                            if (mounted) {
                                              // Start fetching
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20.0),
                    child: _buildGoalBasedQuickActions(
                      context,
                      theme,
                      authStore.personalization,
                    ),
                  ),
                  20.verticalSpace,
                  Padding(
                        ...
                        return Column(
                          children: taskStore.tasks.take(5).map((task) {
                            return Container(
                              ...
                              context.push(
                                TasksListScreen(highlightTaskId: task.id),
                              );
                            });
                          }).toList(),
                        );
  ...
  Widget _buildDailyHubRow(
    BuildContext context,
    AppTheme theme,
    AppAuthProvider authStore,
  ) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SecondaryText(
                  text:
                      'Complete your daily pack, first win tasks, and get AI guidance',
                  fontSize: 11,
                  color: theme.accentTxt.withOpacity(0.6),
                ),
              ],
  ...
  Widget buildCalendarCard(BuildContext context, AppTheme theme) {
    return GlassContainer(
      padding: const EdgeInsets.all(20),
      gradient: theme.glassGradient,
      border: Border.all(color: theme.primaryBase.withOpacity(0.25)),
