...
class AppHelper {
                        ...
                        if (!force && !isUpdating)
                          Positioned(
                            ...
                            child: const Icon(
                              Icons.close,
                              color: Colors.white,
                            ).clickable(() => Navigator.of(dialogCtx).pop()),
                          ),
                        Positioned(
                          bottom: 10,
                          left: 20,
                          ...
                          CustomButton(
                            ...
                            onPressed: isUpdating
                                ...
                                : () async {
                                    ...
                                    try {
                                      await InAppUpdateService().performAppUpdate(
                                        dialogCtx,
                                        isForceUpdate: force,
                                      );
                                    } finally {
  ...
  static Future<void> launchURL(String url) async {
    ...
    try {
      ...
      safePrint('Could not launch $url with externalApplication: $e');
      try {
        await url_launcher.launchUrl(
          uri,
          mode: url_launcher.LaunchMode.platformDefault,
        ...
        safePrint('Could not launch $url with platformDefault fallback: $e2');
      }
    }
  }
